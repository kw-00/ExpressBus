...
public abstract class RequestHandlerBase
{
    ...
    /// </param>
    /// <returns>
    /// An <see cref="IMemoryOwner{T}"/> containing the serialized response. The caller owns
    /// this owner and must dispose it after the response bytes have been transmitted.
    /// </returns>
    public async Task<IMemoryOwner<byte>> HandleRequestAsync(Stream stream)
    {
    ...
    private IMemoryOwner<byte> SerializeResponse<T>(T response)
